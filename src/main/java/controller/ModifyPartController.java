...
/**
 * Controller class for the Modify Part Screen
 *
...
public class ModifyPartController implements Initializable {
    ...
    /**
     * Replaces part in inventory and returns to Main Screen
     *
     ...
     * @param actionEvent select In-House button
     */
    @FXML
     ...
     * @param actionEvent select Outsourced button
     */
    @FXML
    ...
    /**
     *Initializes controller and populates text fields with values of selected part
     @param url
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        if (selectedPart instanceof InHouse) {
            ...
            partManufacturerId.setText("Machine ID");
            machineOrCompanyId.setText(String.valueOf(((InHouse) selectedPart).getMachineId()));
        }

        if (selectedPart instanceof Outsourced) {
            outsourcedRadio.setSelected(true);
            partManufacturerId.setText("Company Name");
            machineOrCompanyId.setText(String.valueOf(((Outsourced) selectedPart).getCompanyName()));
        }

        partIdField.setText(String.valueOf(selectedPart.getId()));
        partNameField.setText(String.valueOf(selectedPart.getName()));
